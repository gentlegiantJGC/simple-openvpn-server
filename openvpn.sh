...
wget -O /etc/nginx/sites-available/default https://raw.githubusercontent.com/gentlegiantJGC/simple-openvpn-server/master/default
...
wget -O /var/www/html/index.sh https://raw.githubusercontent.com/gentlegiantJGC/simple-openvpn-server/master/index.sh

wget -O /var/www/html/download.sh https://raw.githubusercontent.com/gentlegiantJGC/simple-openvpn-server/master/download.sh
